...
namespace oat\taoOutcomeRds\scripts\tools;
...
/**
 * Class KvToRdsMigration
 *
 * Script to migrate result storage from KeyValue to RDS
 * `php index.php '\oat\taoOutcomeRds\scripts\tools\KvToRdsMigration' [--wet-run] [-h]`
 *
 */
